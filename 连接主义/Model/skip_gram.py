...
obj_path = r'data\train.txt'
stop_word_file = r"data\stop_word.txt"
...
def predict(test_word, word2id, top_k=4):  # 测试训练的词向量
    ...
    """
    sess = tf.Session()
    check_point_file = tf.train.latest_checkpoint(r'global_variables')  # 加载模型
...
if __name__ == "__main__":
    ...
    for _ in train_data.get_batch_data(7):
        print(_)
    # print(words)
